...
include(":app:feature:insurances")
...
include(":app:molecule:molecule-android")
include(":app:molecule:molecule-public")
include(":app:molecule:molecule-test")
include(":app:navigation:core")
include(":app:navigation:navigation-activity")
include(":app:navigation:navigation-compose-typed")
include(":app:notification-badge-data:fake")
include(":app:notification-badge-data:public")
