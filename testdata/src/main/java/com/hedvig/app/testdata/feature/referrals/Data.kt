...
val LOGGED_IN_DATA_WITH_KEY_GEAR_AND_REFERRAL_FEATURE_ENABLED = LoggedInDataBuilder().build()
val LOGGED_IN_DATA_WITH_KEY_GEAR_FEATURE_ENABLED = LoggedInDataBuilder().build()
val LOGGED_IN_DATA_WITH_REFERRALS_ENABLED = LoggedInDataBuilder().build()
