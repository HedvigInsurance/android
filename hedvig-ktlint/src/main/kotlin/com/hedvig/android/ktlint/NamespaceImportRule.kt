 ...
 *
 * ktlint has no type resolution, so an owner is recognized by the shape of the import path rather
 * than by resolving it, and [CAPITALIZED_PACKAGES] carries the exceptions that costs us.
 */
