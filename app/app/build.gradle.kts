...
dependencies {
  ...
  implementation(projects.app.featureBusinessmodel)
  implementation(projects.app.featureChangeaddress)
  implementation(projects.app.featureOdyssey)
  implementation(projects.app.featureTerminateInsurance)
