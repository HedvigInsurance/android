...
import hedvig.resources.REMOVE_ADDON_SUCCESS_SUBTITLE
import hedvig.resources.REMOVE_ADDON_SUCCESS_TITLE
...
internal fun RemoveAddonSuccessScreen(activationDate: LocalDate, popBackstack: () -> Unit) {
  ...
  Column(
    ...
    EmptyState(
      ...
      text = stringResource(Res.string.REMOVE_ADDON_SUCCESS_TITLE),
      description = stringResource(
        Res.string.REMOVE_ADDON_SUCCESS_SUBTITLE,
        formattedDate,
      ),
      iconStyle = SUCCESS,
