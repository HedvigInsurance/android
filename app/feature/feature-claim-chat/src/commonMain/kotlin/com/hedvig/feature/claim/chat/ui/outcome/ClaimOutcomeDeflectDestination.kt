    ...
    Column {
      ...
      Column(
        ...
        when (deflect.partnersContainer) {
          is StepContent.Deflect.DeflectPartnerContainer.ExtendedPartnerContainer -> ExtendedPartnersScreen(
          ...
          is StepContent.Deflect.DeflectPartnerContainer.SimplePartnerContainer -> SimplePartnersScreen(
            contentTitle = deflect.content.title,
            contentDescription = deflect.content.description,
            openUrl = openUrl,
...
private fun ColumnScope.ExtendedPartnersScreen(
  infoText: String?,
  warningText: String?,
  partners: List<StepContent.Deflect.DeflectPartnerContainer.ExtendedPartner>,
  contentTitle: String,
...
@Composable
private fun QuestionsAndAnswers(faqList: List<InfoBlock>, modifier: Modifier = Modifier) {
  Column(modifier) {
    AccordionList(
      faqList.map { faq ->
    ...
    Surface(color = HedvigTheme.colorScheme.backgroundPrimary) {
      ClaimOutcomeDeflectDestination(
        deflect = StepContent.Deflect(
          ...
          partnersInfo = InfoBlock("title", "description"),
          content = InfoBlock("title", "description"),
          faq = emptyList(),
