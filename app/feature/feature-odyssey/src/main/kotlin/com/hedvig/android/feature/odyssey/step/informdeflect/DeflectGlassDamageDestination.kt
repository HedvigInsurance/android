...
internal fun DeflectGlassDamageDestination(
  parameter: ClaimFlowDestination.DeflectGlassDamage,
  openChat: () -> Unit,
  closeClaimFlow: () -> Unit,
  ...
  ClaimFlowScaffold(
    ...
    VectorInfoCard(
      text = stringResource(id = R.string.SUBMIT_CLAIM_GLASS_DAMAGE_INFO_LABEL),
    ...
    parameter.partners.forEach { partner ->
      HedvigCard(
        ...
        Column {
          ...
          Spacer(modifier = Modifier.height(16.dp))
          Text(
            text = stringResource(id = R.string.SUBMIT_CLAIM_GLASS_DAMAGE_ONLINE_BOOKING_LABEL),
          ...
          HedvigContainedButton(
            text = stringResource(id = R.string.SUBMIT_CLAIM_GLASS_DAMAGE_ONLINE_BOOKING_BUTTON),
            onClick = {
              val url = partner.url
              if (url != null) {
                openUrl(url)
    ...
    Spacer(modifier = Modifier.height(16.dp))
    Text(
      text = stringResource(id = R.string.SUBMIT_CLAIM_HOW_IT_WORKS_TITLE),
      modifier = Modifier.padding(horizontal = 16.dp),
    )
    Spacer(modifier = Modifier.height(8.dp))
    Text(
      text = stringResource(id = R.string.SUBMIT_CLAIM_GLASS_DAMAGE_HOW_IT_WORKS_LABEL),
      modifier = Modifier.padding(horizontal = 16.dp),
