...
@Inject
internal class TerminateInsuranceDeepLinkMatcherProvider(
  ...
  override fun matchers(): List<DeepLinkMatcher<out Destination>> =
    uriDeepLinkMatchers(container.terminateInsurance, TerminateInsuranceGraphDestination.serializer())
}
