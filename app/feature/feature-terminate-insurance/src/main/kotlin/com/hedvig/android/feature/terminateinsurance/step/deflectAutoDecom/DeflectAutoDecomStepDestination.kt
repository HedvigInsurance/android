...
internal fun DeflectAutoDecomStepDestination(
    ...
    LaunchedEffect(uiState) {
        val uiStateValue = uiState as? DeflectAutoDecomUiState.Success ?: return@LaunchedEffect
...
private fun DeflectAutoDecomStepScreen(
    ...
    when (uiState) {
        ...
        DeflectAutoDecomUiState.Loading -> HedvigFullScreenCenterAlignedProgress()
        is DeflectAutoDecomUiState.Success -> DeflectAutoDecomStepSuccessScreen(
            navigateUp = navigateUp,
            closeTerminationFlow = closeTerminationFlow,
