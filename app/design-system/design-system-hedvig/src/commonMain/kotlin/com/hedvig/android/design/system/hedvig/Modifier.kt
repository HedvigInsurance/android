 ...
 */
fun Modifier.notificationCircle(showNotification: Boolean = true, color: Color = NotificationCircleDefaultColor) =
  this.drawWithContent {
    drawContent()
    if (showNotification) {
      // The circle takes up ~34% of the icon's size
...
val NotificationCircleDefaultColor = Color(0xFFFF513A)
