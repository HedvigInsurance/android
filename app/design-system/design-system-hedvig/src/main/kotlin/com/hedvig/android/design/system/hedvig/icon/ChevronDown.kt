...
val HedvigIcons.ChevronDown: ImageVector
  get() {
    ...
    return ImageVector.Builder(
      ...
      // M4.97 8.97 a.75 .75 0 0 1 1.06 0 l5.8 5.8 a.25 .25 0 0 0 .35 0 l5.79 -5.8 a.75 .75 0 1 1 1.06 1.06 l-5.8 5.8 a1.75 1.75 0 0 1 -2.47 0 l-5.79 -5.8 a.75 .75 0 0 1 0 -1.06
      path(
        fill = SolidColor(Color(0xFF121212)),
      ) {
        // M 4.97 8.97
        moveTo(x = 4.97f, y = 8.97f)
