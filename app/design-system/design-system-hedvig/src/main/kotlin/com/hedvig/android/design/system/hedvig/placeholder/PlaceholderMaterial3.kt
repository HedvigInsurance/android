...
/**
 * Returns the value used as the the `color` parameter value on [Modifier.hedvigPlaceholder].
 *
 ...
 * [Modifier.hedvigPlaceholder], along with the values provided by [PlaceholderDefaults].
 *
...
fun Modifier.hedvigPlaceholder(
  ...
  Modifier.hedvigPlaceholder(
    ...
    shape = shape ?: HedvigTheme.shapes.cornerSmall,
    highlight = highlight,
