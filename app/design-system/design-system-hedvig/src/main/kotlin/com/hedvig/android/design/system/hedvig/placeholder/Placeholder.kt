...
/**
 * Contains default values used by [Modifier.hedvigPlaceholder] and [PlaceholderHighlight].
 */
internal object PlaceholderDefaults {
  ...
  internal val shimmerAnimationSpec: InfiniteRepeatableSpec<Float> by lazy {
    infiniteRepeatable(
      animation = tween(durationMillis = 1700, delayMillis = 0),
...
internal fun Modifier.hedvigPlaceholder(
  visible: Boolean,
  color: Color,
