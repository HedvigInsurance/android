...
internal fun HedvigMaterial3Theme(darkTheme: Boolean = isSystemInDarkTheme(), content: @Composable () -> Unit) {
  ...
  val (colorScheme, hedvigColorTheme) = when {
    darkTheme -> {
      val m3ColorScheme = darkColorScheme(hedvigTonalPalette)
      m3ColorScheme to darkHedvigColorScheme(hedvigTonalPalette, m3ColorScheme)
    }

    else -> {
      val m3ColorScheme = lightColorScheme(hedvigTonalPalette)
      m3ColorScheme to lightHedvigColorScheme(hedvigTonalPalette, m3ColorScheme)
    }
  }
  MaterialTheme(
...
internal fun darkHedvigColorScheme(hedvigTonalPalette: HedvigTonalPalette, colorScheme: ColorScheme) =
  HedvigMaterial3ColorScheme(
    ...
    lightTypeContainer = hedvigTonalPalette.green300,
    onLightTypeContainer = hedvigTonalPalette.green900,
...
internal fun lightHedvigColorScheme(hedvigTonalPalette: HedvigTonalPalette, colorScheme: ColorScheme) =
  HedvigMaterial3ColorScheme(
    ...
    lightTypeContainer = hedvigTonalPalette.green50,
    onLightTypeContainer = hedvigTonalPalette.greyscale1000,
