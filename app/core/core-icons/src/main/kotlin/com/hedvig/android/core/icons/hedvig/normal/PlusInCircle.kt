...
public val HedvigIcons.CircleWithPlus: ImageVector
  get() {
    if (_circleWithPlus != null) {
      return _circleWithPlus!!
    }
    _circleWithPlus = materialIcon(name = "Circle with plus") {
...
private var _circleWithPlus: ImageVector? = null
