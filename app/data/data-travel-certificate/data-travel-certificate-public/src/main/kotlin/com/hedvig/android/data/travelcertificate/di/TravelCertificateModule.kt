...
import com.hedvig.android.data.travelcertificate.GetCoEnsuredForContractUseCaseImpl
...
val travelCertificateDataModule = module {
  ...
  single<GetCoEnsuredForContractUseCase> {
    GetCoEnsuredForContractUseCaseImpl(get<ApolloClient>())
  }
}
