...
import com.hedvig.app.testdata.feature.referrals.LOGGED_IN_DATA_WITH_KEY_GEAR__AND_REFERRAL_FEATURE_ENABLED
...
class NavBarKeyGearAndReferralsTest {
    ...
    val mockServerRule = ApolloMockServerRule(
        LoggedInQuery.QUERY_DOCUMENT to apolloResponse {
            success(
                LOGGED_IN_DATA_WITH_KEY_GEAR__AND_REFERRAL_FEATURE_ENABLED
            )
        }
    )
