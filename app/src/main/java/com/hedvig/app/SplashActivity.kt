...
import com.hedvig.app.util.extensions.hasBeenCelebrated
import com.hedvig.app.util.extensions.observe
import com.hedvig.app.util.extensions.setHasBeenCelebrated
    ...
    private fun startDefaultActivity(loginStatus: LoginStatus?) {
        when (loginStatus) {
            ...
            LoginStatus.LOGGED_IN -> {
                ...
                if (isBirthday) {
                    if (!this.hasBeenCelebrated()) {
                        this.setHasBeenCelebrated(true)
                        startActivity(Intent(this, BirthdayActivity::class.java))
                    } else {
                        startActivity(Intent(this, LoggedInActivity::class.java))
                    }
                } else {
                    this.setHasBeenCelebrated(false)
                    startActivity(Intent(this, LoggedInActivity::class.java))
                }
