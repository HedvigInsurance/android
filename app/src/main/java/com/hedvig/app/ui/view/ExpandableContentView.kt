...
import com.hedvig.app.ui.view.ExpandableContentView.Companion.updateHeight
...
class ExpandableContentView : ConstraintLayout {
    ...
    fun contentSizeChanged() {
        ...
        if (expandedContentHeight < collapsedHeight) {
            binding.expandableContentContainer.updateHeight(expandedContentHeight)
        }

        binding.bottomFadeOut.isVisible = expandedContentHeight > collapsedHeight
        binding.expandableContentToggle.isVisible = expandedContentHeight > collapsedHeight
    }
