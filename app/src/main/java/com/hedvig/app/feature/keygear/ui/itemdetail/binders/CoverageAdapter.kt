...
class CoverageAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) = ViewHolder(
        LayoutInflater.from(parent.context).inflate(R.layout.key_gear_item_detail_coverage_row, parent, false)
    )
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.label.setCompoundDrawablesWithIntrinsicBounds(holder.label.context.compatDrawable(if (isExceptions) {
            R.drawable.ic_cross
        } else {
