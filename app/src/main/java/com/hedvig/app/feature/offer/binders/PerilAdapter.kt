...
import com.hedvig.app.feature.offer.PerilBottomSheet
...
class PerilAdapter(
...
) : RecyclerView.Adapter<PerilAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        holder.bind(list[position], fragmentManager)
    }
    ...
    class ViewHolder(parent: ViewGroup) : RecyclerView.ViewHolder(
        ...
        fun bind(peril: OfferQuery.Peril, fragmentManager: FragmentManager) {
            ...
            itemView.setHapticClickListener {
                PerilBottomSheet
                    .newInstance(itemView.context, peril)
