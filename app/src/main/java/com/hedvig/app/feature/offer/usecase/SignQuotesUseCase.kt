...
class SignQuotesUseCase(
    ...
    suspend fun signQuotesAndClearCache(quoteIds: List<String>, quoteCartId: QuoteCartId?): SignQuoteResult {
    ...
    private suspend fun signQuoteCart(quoteIds: List<String>, quoteCartId: QuoteCartId?): SignQuoteResult {
