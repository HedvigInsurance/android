...
fun TypeOfContract.getStringId() = when (this) {
    ...
    TypeOfContract.DK_HOME_CONTENT_OWN -> R.string.CONTRACT_DISPLAY_NAME_DK_HOME_CONTENT_OWN
    TypeOfContract.DK_HOME_CONTENT_RENT -> R.string.CONTRACT_DISPLAY_NAME_DK_HOME_CONTENT_RENT
    TypeOfContract.DK_HOME_CONTENT_STUDENT_OWN -> R.string.CONTRACT_DISPLAY_NAME_DK_HOME_CONTENT_STUDENT_OWN
    TypeOfContract.DK_HOME_CONTENT_STUDENT_RENT -> R.string.CONTRACT_DISPLAY_NAME_DK_HOME_CONTENT_STUDENT_RENT
    TypeOfContract.DK_TRAVEL_STUDENT -> R.string.CONTRACT_DISPLAY_NAME_DK_TRAVEL_STUDENT
    TypeOfContract.DK_TRAVEL -> R.string.CONTRACT_DISPLAY_NAME_DK_TRAVEL
    TypeOfContract.DK_ACCIDENT -> R.string.CONTRACT_DISPLAY_NAME_DK_ACCIDENT
    TypeOfContract.DK_ACCIDENT_STUDENT -> R.string.CONTRACT_DISPLAY_NAME_DK_ACCIDENT_STUDENT
